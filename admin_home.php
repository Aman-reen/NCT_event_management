    ...
    <section class="section-two">
        <div class="content-container">
            ...
            <div class="video-container">
                <iframe src="https://www.youtube.com/embed/yj6ZeXHCveA"
                    title="Niagara College – Toronto Mirvish Campus Tour" frameborder="0" allowfullscreen>
                </iframe>
            </div>
        </div>
    </section>
    ...
    <section class="info-section">
        <div class="info-container">
            ...
            <div class="info-box" onclick="toggleRaise(this)">
                ...
                <div class="info-text">
                    <h3>Scholarships</h3>
                    <p>To make tuition more accessible, various scholarships are available for international students.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="contact-container">
                ...
                <div class="contact-form">
                    ...
                    <form action="#" method="POST">
                        ...
                        <input type="tel" id="phone" name="phone" placeholder="Telephone (use only numeric characters)"
                            required>
                        ...
                        <div class="checkbox-group">
                            ...
                            <label for="subscribe">I consent to receiving news, special offers, and other marketing
                                emails from TSoM
                        ...
                        <div class="checkbox-group">
                            ...
                            <label for="updates">I would like to receive WhatsApp updates specific to my program of
                                interest,
                ...
                <div class="contact-map">
                    ...
                    <p>Niagara College – Toronto is located in the much-loved, recently revamped community of Mirvish
                        Village. Our
                        spacious new campus accommodates our growing student population in three new buildings, with
                        over 65,450
        ...
        <footer class="footer-section">
            ...
            <div class="footer-bottom">
                ...
                <p>We acknowledge the land we are meeting on is the traditional territory of many nations including
                    the Mississaugas of the Credit, the Anishnabeg, the Chippewa, the Haudenosaunee, and the Wendat
                    peoples
